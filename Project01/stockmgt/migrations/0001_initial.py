...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rctno', models.CharField(max_length=50, null=True)),
                ('rcttype', models.CharField(choices=[('stockin', 'received'), ('stockout', 'issued')], max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='StockIn',
            fields=[
                ...
                ('provided_by', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rctno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stockmgt.receiptinfo')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
